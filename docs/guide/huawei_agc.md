...
下载最新版的 [huawei_agc.zip 压缩包](https://github.com/Kudouran/BiliTools/releases/latest)
...
const downloadUrl = `https://${ghproxy}/https://github.com/Kudouran/BiliTools/releases/download/${tagName.value}/huawei_agc.zip`
</script>
